...
/* harmony import */ var _modules_showMoreStylesServer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/showMoreStylesServer */ "./src/js/modules/showMoreStylesServer.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_13__["default"])(".feedback-slider-item", "", ".main-prev-btn", ".main-next-btn");
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_13__["default"])(".main-slider-item", "vertical");
  ...
  Object(_modules_showMoreStylesServer__WEBPACK_IMPORTED_MODULE_12__["default"])(".button-styles", "#styles .row");
  ...
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_10__["scroll2"])();
...
/*!*************************************!*\
  !*** ./src/js/modules/accordion.js ***!
  \*************************************/
/*! exports provided: default, accordion2 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return accordion; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordion2", function() { return accordion2; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);

function accordion(triggersSelector, itemSelector) {
  var btns = document.querySelectorAll(triggersSelector);
  var blocks = document.querySelectorAll(itemSelector);
...
function accordion2(triggersSelector) {
  var btns = document.querySelectorAll(triggersSelector);
  btns.forEach(function (btn) {
...
var filter = function filter() {
  ...
  function filterFn() {
    ...
    args.forEach(function (name) {
      var btn = menu.querySelector(name);
...
function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      e.preventDefault(); //creaza div-ul unde va fi mesajul

      var statusMessageDiv = document.createElement("div");
      statusMessageDiv.classList.add("status"); //pune div-ul dupa forma

      item.parentNode.appendChild(statusMessageDiv);
      item.classList.add("animated", "fadeOutUp"); //adaugam spinerul si mesajul de loading

      var statusImg = document.createElement("img");
      statusImg.setAttribute("src", message.spinner);
      statusImg.classList.add("animated", "fadeInUp");
      var textMessage = document.createElement("div");
      textMessage.textContent = message.loading; //scoate forma in 4ms
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        document.body.style.marginRight = "".concat(Object(_calcScroll__WEBPACK_IMPORTED_MODULE_1__["default"])(), "px");
      });
    });
...
function pictureSize(imgSelector) {
  ...
  function hideImg(block) {
    ...
    block.querySelectorAll("p").forEach(function (element) {
...
function showMoreStyles(trigger, styles) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return showMoreStylesServer; });
...
function showMoreStylesServer(trigger, wrapper) {
